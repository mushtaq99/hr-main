<ul class="menu-inner py-1">
    ...
    <li class="menu-item active">
        <a href="index.html" class="menu-link">
            ...
            <div data-i18n="Analytics">KPFSA</div>
        </a>
    </li>
        ...
        <ul class="menu-sub">
            <li class="menu-item">
                <a href="/users" class="menu-link">
                    <div data-i18n="Perfect Scrollbar">Users</div>
                </a>
            </li>
            <li class="menu-item">
                <a href="/permissions" class="menu-link">
                    <div data-i18n="Perfect Scrollbar">Permissions</div>
                </a>
            </li>
            <li class="menu-item">
    ...
    <li class="menu-item">
        ...
        <ul class="menu-sub">
            ...
            <li class="menu-item">
                <a href="/permissions" class="menu-link">
                    <div data-i18n="Perfect Scrollbar">Add Profile</div>
                </a>
            </li>
            <li class="menu-item">
                <a href="/roles" class="menu-link">
