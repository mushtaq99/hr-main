                ...
                <div class="bg-white shadow-md rounded my-6 p-5">
                    <form method="POST" action="/roles/{{$role['id']}}">
                        ...
                        <div class="text-center mt-16">
                            <button type="submit" class="bg-blue-500 text-black font-bold px-5 py-1 rounded focus:outline-none shadow hover:bg-green-500 transition-colors ">Update</button>
                        </div>
                    </form>
                </div>
